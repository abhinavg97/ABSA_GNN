...
class GraphDataModule(pl.LightningDataModule):
    ...
    def __init__(self, train_batch_size=cfg['training']['train_batch_size'],
                 ...
                 dataset_dataframe=cfg['paths']['dataset_dataframe'], label_text_to_label_id=cfg['paths']['label_text_to_label_id'],
                 train_graphs=cfg['paths']['saved_train_graphs'], large_graph=cfg['paths']['saved_large_graph'],
                 dataset_info=cfg['data']['dataset']):
        super().__init__()
        self.dataset_info = dataset_info
        self.graph_data = GraphDataset(dataset_df_path=data_root+dataset_dataframe,
                                       label_text_to_label_id_path=data_root+label_text_to_label_id,
                                       dataset_path=data_root+dataset, dataset_info=self.dataset_info,
                                       train_graphs_path=data_root+train_graphs, large_graph_path=data_root+large_graph)
    ...
    def large_graph(self):
        ...
        """
        return self.graph_data.large_graph
